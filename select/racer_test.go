...
func TestRacer(t *testing.T) {
	t.Run("compare speed of servers, return url of the fastest one", func(t *testing.T) {
	...
	t.Run("returns a error if a server doesn't respond within specified time", func(t *testing.T) {
